...
def on_message(self, msg):
    ...
    off for later.
    """
    url= 'https://api.us-east.text-to-speech.watson.cloud.ibm.com/instances/42ec9509-ac25-490c-954f-ecbcf69c4397'
    apiKey= 'cKFKM0f8ldq-ZfCvd1vpfitPtUAgUlD7sEjR4eP5mveL'
    ...
    if "results" in data:
        if data["results"][0]["final"]:
            ...
            with open('./mySpeech.mp3', 'wb') as audio_file:
                res= tts.synthesize(text, accept= 'audio/mp3', voice= 'en-US_AllisonV3Voice').get_result()
                audio_file.write(res.content)
            playsound('mySpeech.mp3')    
        ...
        with open ('output.txt', 'w') as f:
           f.writelines(data['results'][0]['alternatives'][0]['transcript'])
